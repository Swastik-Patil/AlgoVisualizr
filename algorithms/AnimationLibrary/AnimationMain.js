...
function initCanvas() {
  ...
  explainButton = addControlToAnimationBar("Button", "Explain");
  explainButton.onclick = animationManager.explain.bind(animationManager);
...
function AnimationManager(objectManager) {
  ...
  this.explain = function () {
    let explaination = document.getElementById("explaination").innerText;
  };
